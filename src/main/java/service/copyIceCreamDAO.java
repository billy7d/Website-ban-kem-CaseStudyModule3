...
public class copyIceCreamDAO {
    ...
    public boolean updateIceCream(IceCream iceCream) {
    ...
    public List<IceCream> searchIceCreamByCategory(int idCategory) {
    ...
    public List<IceCream> sortIceCreamByPrice() {
        List<IceCream> iceCreams = new ArrayList<>();
    ...
    public List<IceCream> sortIceCreambyQuantity(String Quantity){
        List<IceCream> iceCreams = new ArrayList<>();
